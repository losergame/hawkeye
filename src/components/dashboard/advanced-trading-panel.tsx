      ...
      <div className="mt-3 grid gap-2 lg:grid-cols-2">
        <div className="rounded-lg border border-white/10 bg-white/[0.04] p-3">
          ...
          <div className="grid grid-cols-3 gap-2 text-sm">
            <span className="rounded-lg bg-white/[0.05] px-3 py-2 text-slate-300">{selected.symbol}</span>
            <span className="rounded-lg bg-white/[0.05] px-3 py-2 text-slate-300">25 shares</span>
        ...
        <div className="rounded-lg border border-white/10 bg-white/[0.04] p-3">
          ...
          <p className="text-sm leading-6 text-slate-300">{selected.swingTradeIdea}</p>
        </div>
      </div>
    </Panel>
  );
